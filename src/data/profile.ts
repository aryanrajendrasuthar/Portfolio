export const profile = {
  name: "Aryan Rajendra Suthar",
  headline:
    "Software Engineer | Backend & Distributed Systems | Cloud-Native Microservices (Java, Spring Boot, AWS, Kafka) | AI/ML Applications",
  subHeadline: "Subject Area Tutor @ ASU | MS Software Engineering @ ASU",
